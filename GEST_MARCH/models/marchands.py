...
class Marchands(Personne):
   ...
   def __init__(self, nom, contact, coordonneeX, coordonneeY, stock=None, code_id=None):
      """Initialisation d'un marchand"""
      super().__init__(code_id, nom, contact) # Initialisation de la classe parente
   ...
   def occup_stand(self, marche):
      """Occuper un stand dans un marché"""

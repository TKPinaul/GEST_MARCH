...
def main():
   while True:
      ...
      print("2. Gestion des Marchés")
      print("3. Gestion des Marchands")
      print("4. Gestion des Transactions d'Entrée (rentre de stock)")
      print("5. Gestion des Transactions de Sortie (sorties de stock)")
      print("6. Quitter")
